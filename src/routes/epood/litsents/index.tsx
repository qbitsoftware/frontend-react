...
export const Route = createFileRoute("/epood/litsents/")({
...
function RouteComponent() {
  ...
  const calculateLicenseExpiration = (
    ...
    if (currentYear > 2025) {
      ...
      const daysUntilEndOf2025 = Math.ceil(
        (endOf2025.getTime() - now.getTime()) / (1000 * 60 * 60 * 24)
      );
                    ...
                    <div className="w-full sm:w-auto sm:border-l-2 sm:border-gray-200 sm:pl-4 sm:ml-4">
                      ...
                      >
                        ...
                        <span className="sm:hidden">
                          {t("licenses.add_player.add_player_short", "Add New")}
                        </span>
                      </button>
                    </div>
                  </div>
                ...
                <div className="mb-3 sm:mb-6 space-y-2 sm:space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setAgreedToLicenseTerms(e.target.checked)
                      }
                      className="mt-1 w-4 h-4 text-green-600 border-2 border-gray-300 rounded focus:ring-green-500 focus:ring-2"
                    />
                    <label
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setAgreedToGuardianConsent(e.target.checked)
                      }
                      className="mt-1 w-4 h-4 text-green-600 border-2 border-gray-300 rounded focus:ring-green-500 focus:ring-2"
                    />
                    <label
