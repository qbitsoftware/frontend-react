...
export function RatingRowSkeleton() {
    return (
        <TableRow className="group">
            <TableCell className="px-1 sm:px-2 md:px-4 lg:px-6 py-2 sm:py-3 w-16 sm:w-20">
            ...
            <TableCell className="px-1 sm:px-2 md:px-4 lg:px-6 py-2 sm:py-3 w-12 sm:w-16 hidden sm:table-cell">
                <Skeleton className="h-3 sm:h-4 w-6 sm:w-8 md:w-12" />
            </TableCell>
        </TableRow>
    );
...
export default function RatingRow({ user, setSelectedPlayerId, setIsModalOpen, displayIndex, isGenderCombined }: Props) {
    return (
        ...
        >
            <TableCell className={`px-2 sm:px-2 md:px-4 lg:px-6 py-2 sm:py-3 text-sm sm:text-sm md:text-base lg:text-lg font-bold w-16 sm:w-20 text-left whitespace-nowrap ${
            ...
            <TableCell className="px-1 sm:px-2 md:px-4 lg:px-6 py-2 sm:py-3 flex items-center space-x-2 sm:space-x-3 md:space-x-4 min-w-0">
            ...
            <TableCell className="px-2 sm:px-2 md:px-4 lg:px-6 py-2 sm:py-3 text-xs sm:text-sm w-12 sm:w-16 text-left">
                {user.rate_pl_points}
            </TableCell>
            <TableCell className="px-2 sm:px-2 md:px-4 lg:px-6 py-2 sm:py-3 text-xs sm:text-sm w-12 sm:w-16 text-left hidden sm:table-cell">
                {user.rate_points}
            </TableCell>
        </TableRow>
    )
