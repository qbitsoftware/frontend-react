  ...
  return (
    ...
    >
      <div className="absolute top-1.5 sm:top-2 right-1.5 sm:right-2 flex items-center gap-1 text-green-600 px-1 py-0.5">
        ...
        <span className="text-xs sm:text-sm font-extrabold">+{riser.positionChange}</span>
      </div>

      <div className="relative">
        <div className="mb-1 sm:mb-2">
          <h4 className="font-bold text-gray-700 text-xs sm:text-sm leading-tight truncate group-hover:text-[#4C97F1] transition-colors duration-200 mb-0.5">
            {riser.playerName}
          </h4>
