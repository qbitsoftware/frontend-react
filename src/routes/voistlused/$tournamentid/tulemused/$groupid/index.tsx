...
function RouteComponent() {
  ...
  if (
    !bracketQuery.data?.data ||
    !tableQuery.data?.data ||
    !tablesQuery.data?.data ||
    !tableQuery.data.data.group
  ) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Match details modal */}
      {selectedMatch &&
        !tableQuery.data.data.group.solo &&
        tableQuery.data.data.group.dialog_type != DialogType.DT_FIXED_DOUBLES &&
        tableQuery.data.data.group.dialog_type !== DialogType.DT_DOUBLES && (
          <Protocol
