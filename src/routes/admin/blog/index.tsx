...
function RouteComponent() {
  ...
  if ((!blogData || !blogData.data || blogData.data.blogs.length < 1) && !isLoading) {
    return (
  ...
  const filteredBlogs = blogData && blogData.data && blogData.data.blogs && blogData.data.blogs.filter(
    (blog) =>
