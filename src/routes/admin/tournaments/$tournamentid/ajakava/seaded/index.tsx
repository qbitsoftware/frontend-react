...
function RouteComponent() {
  ...
  // const tournamentQuery = UseGetTournamentAdmin(Number(tournamentid));

  if (tournamentTablesQuery.isLoading ) {
    return (
  ...
  // if (!tournamentTablesQuery.data?.data || !tournamentQuery.data) {
  //   return (
  //     <div className="flex items-center justify-center h-64">
  //       <div className="text-lg text-gray-500">
