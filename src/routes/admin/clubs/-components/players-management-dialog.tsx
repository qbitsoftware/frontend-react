...
import { Users, Plus, X, UserIcon, ArrowLeft, UserPlus, Search } from "lucide-react";
        ...
        <DialogContent className="max-w-[90vw] sm:max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-auto space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-500">
                        {isLoadingPlayers ? t("admin.clubs.players_modal.list.loading") : `${filteredClubPlayers.length} ${filteredClubPlayers.length === 1 ? t("admin.clubs.players_modal.list.count.singular") : t("admin.clubs.players_modal.list.count.plural")}`}
                      </span>
                    </div>
                  </div>
                  <Button
              ...
              <div className="p-4">
                {!showAddPlayer && clubPlayers.length > 0 && (
                  <div className="mb-4">
                    <div className="relative">
                      <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                      <Input
                        type="text"
                        placeholder={t("admin.clubs.players_modal.search_players_placeholder")}
                  ...
                  {isLoadingPlayers ? (
                    ...
                    <div className="overflow-auto max-h-[400px]">
                      <Table>
                        ...
                        <TableBody>
                          {filteredClubPlayers.map((player, index) => (
                    ...
                    <div className="text-center py-12">
                      ...
                      <h3 className="font-medium text-gray-900 mb-2">{t("admin.clubs.players_modal.search_no_results.title")}</h3>
                      <p className="text-gray-500 mb-4">{t("admin.clubs.players_modal.search_no_results.description")}</p>
                      <Button
                        variant="outline"
                        onClick={() => setPlayerSearchTerm("")}
                      ...
                      >
                        <X className="w-4 h-4" />
                        {t("admin.clubs.players_modal.search_no_results.clear_search")}
                      </Button>
                    </div>
                  ) : (
                    <div className="text-center py-12">
